...
from Cards.CardObjects.jack_of_spades2 import JackOfSpades2
...
from Cards.CardObjects.king_of_diamonds2 import KingOfDiamonds2
from Cards.CardObjects.king_of_hearts import KingOfHearts
from Cards.CardObjects.king_of_hearts2 import KingOfHearts2
from Cards.CardObjects.king_of_spades import KingOfSpades
from Cards.CardObjects.king_of_spades2 import KingOfSpades2
from Cards.CardObjects.queen_of_clubs import QueenOfClubs
from Cards.CardObjects.queen_of_clubs2 import QueenOfClubs2
from Cards.CardObjects.queen_of_diamonds import QueenOfDiamonds
from Cards.CardObjects.queen_of_diamonds2 import QueenOfDiamonds2
from Cards.CardObjects.queen_of_hearts import QueenOfHearts
from Cards.CardObjects.queen_of_hearts2 import QueenOfHearts2
from Cards.CardObjects.queen_of_spades import QueenOfSpades
from Cards.CardObjects.queen_of_spades2 import QueenOfSpades2
...
yes = (TenOfClubs, TenOfDiamonds, TenOfHearts, TenOfSpades, TwoOfClubs, TwoOfDiamonds, TwoOfHearts, TwoOfSpades, ThreeOfClubs, ThreeOfDiamonds, ThreeOfHearts, ThreeOfSpades, FourOfClubs, FourOfDiamonds, FourOfHearts, FourOfSpades, FiveOfClubs, FiveOfDiamonds, FiveOfHearts, FiveOfSpades, SixOfClubs, SixOfDiamonds, SixOfHearts, SixOfSpades, SevenOfClubs, SevenOfDiamonds, SevenOfHearts, SevenOfSpades, EightOfClubs, EightOfDiamonds, EightOfHearts, EightOfSpades, NineOfClubs, NineOfDiamonds, NineOfHearts, NineOfSpades, AceOfClubs, AceOfDiamonds, AceOfHearts, AceOfSpades, AceOfSpades2, JackOfClubs, JackOfClubs2, JackOfDiamonds, JackOfDiamonds2, JackOfHearts, JackOfHearts2, JackOfSpades, JackOfSpades2, KingOfClubs, KingOfClubs2, KingOfDiamonds, KingOfDiamonds2, KingOfHearts, KingOfHearts2, KingOfSpades, KingOfSpades2, QueenOfClubs, QueenOfClubs2, QueenOfDiamonds, QueenOfDiamonds2, QueenOfHearts, QueenOfHearts2, QueenOfSpades, QueenOfSpades2)
